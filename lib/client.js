...
const KEY$2 = "dshPetSpriteWitness:days";
const KEEP_DAYS = 14;
...
function saveAll(all) {
	try {
		...
		localStorage.setItem(KEY$2, JSON.stringify(pruned));
	} catch {}
}
/**
...
const MAX_TEXT = 60;
const KEY$1 = "dshPetSpriteMemory:items";
...
const CarePanel = ({ engine, anchor, petName, chatModel, onChatModelChange, profile, onProfileChange, onGeneratePet, onImportPet, onPetSay, onSwitchPet, memories, onRemoveMemory, autoMemory, onAutoMemoryChange, workspace, onClose }) => {
						...
						children: [
							...
							linesOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", { children: "切换会话（主人换了工地）" }),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
										value: linesText("switch"),
										onChange: (e) => setLines("switch", e.target.value),
										rows: 2,
										placeholder: "换个地方啦。\n这个工地我来过吗？"
									})
								]
