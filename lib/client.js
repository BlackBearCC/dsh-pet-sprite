...
const CarePanel = ({ engine, anchor, petName, chatModel, onChatModelChange, persona, onPersonaChange, onGeneratePet, onSwitchPet, onClose }) => {
...
const PetCard = ({ pet, isCurrent, state, onPick }) => {
