window.__ModuleLoader__.load({ id: "dsh-pet", factory: (require) => {
...
const CarePanel = ({ engine, anchor, onClose }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dsh-pet-tabs",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						className: `dsh-pet-tab ${tab === "status" ? "on" : ""}`,
						onClick: () => setTab("status"),
						children: "状态"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						className: `dsh-pet-tab ${tab === "bag" ? "on" : ""}`,
						onClick: () => setTab("bag"),
						children: "背包"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						className: `dsh-pet-tab ${tab === "shop" ? "on" : ""}`,
						onClick: () => setTab("shop"),
						children: "商店"
					})
				]
...
const ChatPet = () => {
	...
	(0, react.useEffect)(() => {
		...
		let count = 0;
		try {
			count = parseInt(localStorage.getItem("dshPetClicks") ?? "0", 10) || 0;
		} catch {
			count = 0;
		}
		let badgeTimer;
		...
		const onPointerDown = (e) => {
			...
			if (t.closest(".dsh-pet-unit,a,button,input,textarea,select,label,[role=\"button\"],[contenteditable]")) return;
			setCtl(true);
		...
		const onClickPet = () => {
			count++;
			try {
				localStorage.setItem("dshPetClicks", String(count));
			} catch {}
			if (!still) {
				burst();
				if (state !== "climb") {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref: layerRef,
		className: "dsh-pet-layer",
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			ref: unitRef,
			className: "dsh-pet-unit",
			title: "Pet（右键打开照顾面板）",
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					ref: countRef,
					className: "dsh-pet-count"
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					ref: ctlRef,
					className: "dsh-pet-ctl"
				}),
