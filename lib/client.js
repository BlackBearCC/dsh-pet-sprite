...
const CarePanel = ({ engine, anchor, petName, chatModel, onChatModelChange, profile, onProfileChange, onGeneratePet, onImportPet, onPetSay, onSpeakPool, onBurst, onSwitchPet, memories, onRemoveMemory, autoMemory, onAutoMemoryChange, workspace, onClose }) => {
					...
					tab === "set" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: generating ? "绘制中……" : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									"生成新伙伴（",
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PixelIcon, {
										icon: "coin",
										size: 11
