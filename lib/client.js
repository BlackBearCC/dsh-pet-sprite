...
const CarePanel = ({ engine, anchor, petName, chatModel, onChatModelChange, onSwitchPet, onClose }) => {
...
const PetChatBox = ({ petId, anchor, model, history, busy, error, onSend, onClear, onClose }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		role: "dialog",
		"aria-label": `和${PET_META[petId].name}聊天`,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const PetCard = ({ id, isCurrent, state, onPick }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: "nm",
				children: PET_META[id].name
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: "tg",
				children: PET_META[id].tagline
			})
		]
	});
};
const PetPicker = ({ currentId, onPick, onClose }) => {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: PET_IDS.map((id) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PetCard, {
						id,
...
function loadPetId() {
	try {
		...
		return PET_IDS.includes(v) ? v : null;
	} catch {
		return null;
	}
}
...
const ChatPet = () => {
			...
			if (now > platsAt) {
				...
				if (!playerCtl && !dragging && mode === "idle" && state === "ground") {
					if (nextChatAt === 0) nextChatAt = now + 15e3 + Math.random() * 15e3;
						...
						const s = engine.getStats();
						say(s.power < 30 || s.mood < 30 ? pick(CHAT_LINES.low) : pick([...CHAT_LINES.idle, ...PET_META[petId].idleLines]));
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			petId && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				ref: unitRef,
				className: "dsh-pet-sprite-unit",
				title: `${PET_META[petId].name}（左键聊天 · 右键照顾面板）`,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						ref: ctlRef,
			...
			!petId && !pickerOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				ref: eggRef,
			...
			petId && panelOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CarePanel, {
				engine,
				anchor,
				petName: PET_META[petId].name,
				chatModel,
			...
			petId && chatOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PetChatBox, {
				petId,
				anchor,
				model: chatModel,
				history: chatHistory,
