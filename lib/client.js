...
.dsh-pet-sprite-chat-send{border:2.5px solid var(--dsw-alias-label-primary,#4a4553);border-radius:10px;background:#ffd33d;color:var(--dsw-alias-label-primary,#4a4553);font:900 12px -apple-system,BlinkMacSystemFont,"PingFang SC",sans-serif;padding:0 15px;cursor:pointer;box-shadow:0 2.5px 0 rgba(0,0,0,.16);transition:transform .12s cubic-bezier(.2,1.5,.4,1)}
