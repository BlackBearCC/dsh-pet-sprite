...
const CarePanel = ({ engine, anchor, petName, chatModel, onChatModelChange, profile, onProfileChange, onGeneratePet, customCount, onImportPet, onPetSay, onSpeakPool, onBurst, onSwitchPet, memories, onRemoveMemory, autoMemory, onAutoMemoryChange, workspace, onClose }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			pickerOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PetPicker, {
				...
				onGeneratePet: chatModel === null ? void 0 : handleGeneratePet,
